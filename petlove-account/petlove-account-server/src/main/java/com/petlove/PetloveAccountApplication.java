...
@Configuration
@ComponentScan({
        UTIL_PACKAGE, BUSINESS_PACKAGE,"com.petlove"
})
...
@EnableFormValidator
@MapperScan("com.petlove.account.dao")
@SpringBootApplication
//@SpringBootApplication(exclude={
//        DataSourceAutoConfiguration.class,
//        DataSourceTransactionManagerAutoConfiguration.class,
//})
public class PetloveAccountApplication {
    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(PetloveAccountApplication.class, args);
